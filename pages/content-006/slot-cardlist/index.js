...
const Cardlist = () => {
  ...
  useEffect(() => {
    ...
    if (!contentId) {
      contentId = '6c9eb91b-3768-4ce3-be63-1798acc73746'; // Fallback content id if none supplied
    }
    ...
    // const url = 'http://localhost:3000/api/content-006/slot-cardlist';
        ...
        <>
          <Container fixed maxWidth="xl" disableGutters={true}>
            <Box id="fixedWidthWrapper" padding="20px 0">
              ...
              >
                {cardlist.content.content006_slot[0].cards.map(
                  (card, index) => (
