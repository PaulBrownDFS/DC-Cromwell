...
const SingleCard = () => {
  ...
  useEffect(() => {
    ...
    if (!contentId) {
      contentId = '9d7a1e48-5462-4dfc-97bb-717b9d6e8af8'; // Fallback content id if none supplied
    }
    ...
    // const url = 'http://localhost:3000/api/content-002/card';
  ...
  return (
    <div>
      <Head>
        <title>Content C002 Card Preview | Dynamic Content Preview</title>
      </Head>
      {loading ? (
